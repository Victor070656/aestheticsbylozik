            ...
            <div class="card">
              <div class="card-body">
                <div class="text-center py-5 px-3">
                  ...
                  <p>Services related to this category will also be deleted. This action cannot be undone.</p>
                  ...
                  if (isset($_POST["delete"])) {
                    $delete = mysqli_query($conn, "DELETE FROM `service_categories` WHERE `id`='$id'");
                    if ($delete) {
                      echo "<script>alert('Deleted!');location.href='category.php'</script>";
                    }
                  }
                  ?>
                </div>

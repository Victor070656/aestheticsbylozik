            ...
            <div class="card">
              <div class="card-body">
                <div class="text-center py-5 px-3">
                  ...
                  <p>Products related to this category will also be deleted. This action cannot be undone.</p>
                  <form method="post" class="mt-3">
                    <a href="product-category.php" class="btn btn-danger">Cancel</a>
                  ...
                  if (isset($_POST["delete"])) {
                    ...
                    if ($delete) {
                      echo "<script>alert('Deleted!');location.href='product-category.php'</script>";
                    }
                  }
                  ?>
                </div>

            ...
            <div class="card">
              <div class="card-body">
                <div class="text-center py-5 px-3">
                  ...
                  <p>All appointments related to this service will also be deleted. This action cannot be undone.</p>
                  ...
                  if (isset($_POST["delete"])) {
                    ...
                    if ($delete) {
                      echo "<script>alert('Deleted!');location.href='services.php'</script>";
                    }
                  }
                  ?>
                </div>

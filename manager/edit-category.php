...
$getCat = mysqli_query($conn, "SELECT * FROM `service_categories` WHERE `id` = '$id'");
                  ...
                  <div class="col-12 mb-4">
                    <form method="post">
                      ...
                      if (isset($_POST["add"])) {
                        ...
                        $addCategory = mysqli_query($conn, "UPDATE `service_categories` SET `category_name` = '$category' WHERE `id` = '$id'");
